...
<body>
    ...
    <div class="main">
        ...
        <div class="flex-con con" style="flex-direction: row; padding-bottom: 0px; padding-top: 0px;">
            <div data-tilt class="first" onclick="show_hide()">
                <img src="alma-sq.jpeg" alt="" width="310px" height="310px">
            </div>
            <div data-tilt class="second" onclick="show_hide1()">
                <img src="obwi-sq.jpeg" alt="" width="310px" height="310px">
            </div>
                <div data-tilt class="third" onclick="show_hide2()">
                    <img src="aport-sq.jpeg" alt="" width="310px" height="310px">
                </div>
                <div data-tilt class="forth" onclick="show_hide3()">
                    <img src="canteen-sq.jpeg" alt="" width="310px" height="310px">
                </div>
        </div>
    ...
    <div class="bari" id="bari">
        ...
        <div class="post1">
            <img src="alma-sq.jpeg" alt=""  width="480px">
            <div class="account" style="display: flex;">
                 <img src="dima.jpeg" alt=""  id="img2">
                <span style="margin-left: 10px;"><b> yerrzhanoov</b></span>
            </div>
            <div class="teaxt">
                <span>
                   <b>Спасибо за прекрасный вечер!</b>
                </span>
    ...
    <div class="bari" id="bari1">
        ...
        <div class="post1">
            <img src="obwi-sq.jpeg" alt=""  width="480px">
            <div class="account" style="display: flex;">
                 <img src="zhm.jpeg" alt=""  id="img2">
                <span style="margin-left: 10px;"><b>abdrakhmanov___1                </b></span>
            </div>
            <div class="teaxt">
                <span>
                   На Арбате с близкими
                </span>
            </div>
            <section class="icoos"><span class="fr66n"><div class="QBdPU "><span class=""><svg aria-label="Не нравится" class="_8-yf5 " fill="#ed4956" height="24" viewBox="0 0 48 48" width="24"><path d="M34.6 3.1c-4.5 0-7.9 1.8-10.6 5.6-2.7-3.7-6.1-5.5-10.6-5.5C6 3.1 0 9.6 0 17.6c0 7.3 5.4 12 10.6 16.5.6.5 1.3 1.1 1.9 1.7l2.3 2c4.4 3.9 6.6 5.9 7.6 6.5.5.3 1.1.5 1.6.5s1.1-.2 1.6-.5c1-.6 2.8-2.2 7.8-6.8l2-1.8c.7-.6 1.3-1.2 2-1.7C42.7 29.6 48 25 48 17.6c0-8-6-14.5-13.4-14.5z"></path></svg></span></div></span>
                <span class="_15y0l"><div class="QBdPU "><svg aria-label="Комментировать" class="_8-yf5 " fill="#262626" height="24" viewBox="0 0 48 48" width="24"><path clip-rule="evenodd" d="M47.5 46.1l-2.8-11c1.8-3.3 2.8-7.1 2.8-11.1C47.5 11 37 .5 24 .5S.5 11 .5 24 11 47.5 24 47.5c4 0 7.8-1 11.1-2.8l11 2.8c.8.2 1.6-.6 1.4-1.4zm-3-22.1c0 4-1 7-2.6 10-.2.4-.3.9-.2 1.4l2.1 8.4-8.3-2.1c-.5-.1-1-.1-1.4.2-1.8 1-5.2 2.6-10 2.6-11.4 0-20.6-9.2-20.6-20.5S12.7 3.5 24 3.5 44.5 12.7 44.5 24z" fill-rule="evenodd"></path></svg></div></span>
    ...
    <div class="bari" id="bari2">
        ...
        <div class="post1">
            <img src="aport-sq.jpeg" alt=""  width="480px">
            <div class="account" style="display: flex;">
                 <img src="ass.jpg" alt=""  id="img2">
                <span style="margin-left: 10px;"><b>asseleyes</b></span>
            </div>
            <div class="teaxt">
                <span>
                   После трудного дня решили отдохнуть и пошопиться
                </span>
            </div>
            <section class="icoos"><span class="fr66n"><div class="QBdPU "><span class=""><svg aria-label="Не нравится" class="_8-yf5 " fill="#ed4956" height="24" viewBox="0 0 48 48" width="24"><path d="M34.6 3.1c-4.5 0-7.9 1.8-10.6 5.6-2.7-3.7-6.1-5.5-10.6-5.5C6 3.1 0 9.6 0 17.6c0 7.3 5.4 12 10.6 16.5.6.5 1.3 1.1 1.9 1.7l2.3 2c4.4 3.9 6.6 5.9 7.6 6.5.5.3 1.1.5 1.6.5s1.1-.2 1.6-.5c1-.6 2.8-2.2 7.8-6.8l2-1.8c.7-.6 1.3-1.2 2-1.7C42.7 29.6 48 25 48 17.6c0-8-6-14.5-13.4-14.5z"></path></svg></span></div></span>
                <span class="_15y0l"><div class="QBdPU "><svg aria-label="Комментировать" class="_8-yf5 " fill="#262626" height="24" viewBox="0 0 48 48" width="24"><path clip-rule="evenodd" d="M47.5 46.1l-2.8-11c1.8-3.3 2.8-7.1 2.8-11.1C47.5 11 37 .5 24 .5S.5 11 .5 24 11 47.5 24 47.5c4 0 7.8-1 11.1-2.8l11 2.8c.8.2 1.6-.6 1.4-1.4zm-3-22.1c0 4-1 7-2.6 10-.2.4-.3.9-.2 1.4l2.1 8.4-8.3-2.1c-.5-.1-1-.1-1.4.2-1.8 1-5.2 2.6-10 2.6-11.4 0-20.6-9.2-20.6-20.5S12.7 3.5 24 3.5 44.5 12.7 44.5 24z" fill-rule="evenodd"></path></svg></div></span>
    ...
    <div class="bari" id="bari3">
        <span onclick="document.getElementById('bari3').style.display='none'" class="close" title="Close Modal">X</span>
        <div class="post1">
            <img src="canteen-sq.jpeg" alt=""  width="480px">
            <div class="account" style="display: flex;">
                 <img src="https://instagram.fcit1-1.fna.fbcdn.net/v/t51.2885-19/s320x320/70088780_516774639111179_1496992236632539136_n.jpg?_nc_ht=instagram.fcit1-1.fna.fbcdn.net&amp;_nc_ohc=WOc2xXEA4j8AX9jjshP&amp;tp=1&amp;oh=addf5db94b0b4f2dc4190e32775e3a9c&amp;oe=5FF65996" alt=""  id="img2">
                <span style="margin-left: 10px;"><b>retakeforever</b></span>
            </div>
            <div class="teaxt">
                <span>
                   TEAM BUILDNG WITH HEARTS
                </span>
            </div>
            <section class="icoos"><span class="fr66n"><div class="QBdPU "><span class=""><svg aria-label="Не нравится" class="_8-yf5 " fill="#ed4956" height="24" viewBox="0 0 48 48" width="24"><path d="M34.6 3.1c-4.5 0-7.9 1.8-10.6 5.6-2.7-3.7-6.1-5.5-10.6-5.5C6 3.1 0 9.6 0 17.6c0 7.3 5.4 12 10.6 16.5.6.5 1.3 1.1 1.9 1.7l2.3 2c4.4 3.9 6.6 5.9 7.6 6.5.5.3 1.1.5 1.6.5s1.1-.2 1.6-.5c1-.6 2.8-2.2 7.8-6.8l2-1.8c.7-.6 1.3-1.2 2-1.7C42.7 29.6 48 25 48 17.6c0-8-6-14.5-13.4-14.5z"></path></svg></span></div></span>
                <span class="_15y0l"><div class="QBdPU "><svg aria-label="Комментировать" class="_8-yf5 " fill="#262626" height="24" viewBox="0 0 48 48" width="24"><path clip-rule="evenodd" d="M47.5 46.1l-2.8-11c1.8-3.3 2.8-7.1 2.8-11.1C47.5 11 37 .5 24 .5S.5 11 .5 24 11 47.5 24 47.5c4 0 7.8-1 11.1-2.8l11 2.8c.8.2 1.6-.6 1.4-1.4zm-3-22.1c0 4-1 7-2.6 10-.2.4-.3.9-.2 1.4l2.1 8.4-8.3-2.1c-.5-.1-1-.1-1.4.2-1.8 1-5.2 2.6-10 2.6-11.4 0-20.6-9.2-20.6-20.5S12.7 3.5 24 3.5 44.5 12.7 44.5 24z" fill-rule="evenodd"></path></svg></div></span>
    ...
    <script>
        ...
        function show_hide3() {
            var click = document.getElementById("bari3");
            if(click.style.display==="none"){
                click.style.display = "block";
            }else {
                click.style.display="none" ;   
